...
| No. of features | Feature | Type | Measurement_Level | Description |
|:---|:---|:---|:---|:---|
| 1st | fixed.acidity | numeric | Ratio | Tartaric acid concentration (g/dm^3) |
| 2nd | volatile.acidity | numeric | Ratio | Acetic acid (vinegar-like) concentration (g/dm^3) |
| 3rd | citric.acid | numeric | Ratio | Citric acid concentration (g/dm^3) |
| 4th | residual.sugar | numeric | Ratio | Residual sugar left after fermentation (g/dm^3) |
| 5th | chlorides | numeric | Ratio | Salt content (g/dm^3) |
| 6th | free.sulfur.dioxide | numeric | Ratio | Free SO2 (mg/dm^3) |
| 7th | total.sulfur.dioxide | numeric | Ratio | Total SO2 (mg/dm^3) |
| 8th | density | numeric | Ratio | Wine density (g/cm^3) |
| 9th | pH | numeric | Interval | pH level of wine |
| 10th | sulphates | numeric | Ratio | Sulphates for microbial stability (g/dm^3) |
| 11th | alcohol | numeric | Ratio | Alcohol content (% vol) |
| 12th | quality | integer | Ordinal | Taster-rated quality score (0–10) |
